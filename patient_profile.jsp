                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="auth">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="doctor_login.jsp"> Doctor Register </a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <nav class="navbar navbar-light bg-light">
                                            ...
                                            <div class="info">
                                                ...
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">Age : <%=age%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">Contact : <%=contact%> </h4>
