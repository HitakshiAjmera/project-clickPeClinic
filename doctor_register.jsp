                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" method="post" action="dr_reg" enctype="multipart/form-data">
                                            <br>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" name="category" required>
                                                                ...
                                                                <option value="3">Emergency Specialists</option>
                                                                <option value="4">Family Physicians</option>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios1" value="" name="member" checked>
                                                                    Free
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="total_patient_checkup"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="online_checkup"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <h3><label>Image upload</label></h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="exampleInputConfirmPassword1" placeholder="Password" name="cpaaswd">
                                            </div>
